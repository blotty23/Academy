def number_scores(score_number, d1, d2, d3, d4, d5)
  total = 0
  [d1, d2, d3, d4, d5].each { |die|
    if die == score_number 
      total += die 
    end
  }
...
class Yatzy
  ...
  def self.ones( d1,  d2,  d3,  d4,  d5)
    number_scores(1, d1,  d2,  d3,  d4,  d5)
  end

  def self.twos( d1,  d2,  d3,  d4,  d5)
    number_scores(2, d1,  d2,  d3,  d4,  d5)
  end

  def self.threes( d1,  d2,  d3,  d4,  d5)
    number_scores(3, d1,  d2,  d3,  d4,  d5)
  end

  def self.fours( d1,  d2,  d3,  d4,  d5)
    number_scores(4, d1,  d2,  d3,  d4,  d5)
  end

  def self.fives( d1,  d2,  d3,  d4,  d5)
    number_scores(5, d1,  d2,  d3,  d4,  d5)
  end

  def self.sixes( d1,  d2,  d3,  d4,  d5)
    number_scores(6, d1,  d2,  d3,  d4,  d5)
  end
  ...
  def self.score_pair( d1,  d2,  d3,  d4,  d5)
    ...
    counts.reverse.each_with_index { |value, index| 
      if value >= 2
        return 2 * (6 - index)
      end
    }
